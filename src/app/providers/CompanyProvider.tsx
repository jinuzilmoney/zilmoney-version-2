...
const INITIAL_COMPANIES: Company[] = [
  { id: '1', name: 'Jas Mon', status: 'owned', description: 'Company Account', isParent: true, createdAt: '2024-01-01T00:00:00.000Z' },
  { id: '2', name: 'C2', status: 'owned', description: 'Company Account', createdAt: '2024-02-01T00:00:00.000Z' },
  { id: '3', name: 'C3', status: 'owned', description: 'Company Account', createdAt: '2024-03-01T00:00:00.000Z' },
  { id: '4', name: 'C4', status: 'owned', description: 'Company Account', createdAt: '2024-04-01T00:00:00.000Z' },
  { id: '5', name: 'C5', status: 'owned', description: 'Company Account', createdAt: '2024-05-01T00:00:00.000Z' },
  { id: '6', name: 'TEST 1', status: 'owned', description: 'Company Account', createdAt: '2024-06-01T00:00:00.000Z' },
];

const INITIAL_INVITED: Company[] = [
  { id: 'inv-1', name: 'VISA', status: 'invited', description: 'Invited Company', createdAt: '2024-01-15T00:00:00.000Z' },
  { id: 'inv-2', name: 'REz', status: 'invited', description: 'Invited Company', createdAt: '2024-02-15T00:00:00.000Z' },
];

export function CompanyProvider({ children }: { children: ReactNode }) {
  const [currentCompany, setCurrentCompany] = useState<Company | null>(null);
  const [companies, setCompanies] = useState<Company[]>(INITIAL_COMPANIES);
  const [invitedCompanies, setInvitedCompanies] = useState<Company[]>(INITIAL_INVITED);
  ...
  useEffect(() => {
    if (isLoaded) {
      ...
      localStorage.setItem('zilmoney-invited-companies', JSON.stringify(invitedCompanies));
    }
  ...
  const updateCompany = (id: string, updates: Partial<Company>) => {
    ...
    if (companyIndex !== -1) {
      ...
      updatedCompanies[companyIndex] = { ...updatedCompanies[companyIndex], ...updates };
    ...
    if (invitedIndex !== -1) {
      ...
      updatedInvited[invitedIndex] = { ...updatedInvited[invitedIndex], ...updates };
