  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="#13B5EA">
        <text x="2" y="18" fontFamily="Arial" fontSize="16" fontWeight="bold">
          xero
        </text>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="#0075DD">
        <text x="0" y="16" fontFamily="Arial" fontSize="10" fontWeight="bold">
          FB
        </text>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="#365EBF">
        <text x="0" y="16" fontFamily="Arial" fontSize="9" fontWeight="bold">
          intuit
        </text>
      </svg>
    ),
    ...
    <div className="space-y-4">
      <div className="relative">
        <div className="absolute inset-0 flex items-center">
          <div
            className={`w-full border-t ${isDark ? "border-white/20" : "border-gray-200"}`}
          />
        </div>
        <div className="relative flex justify-center text-sm">
          <span
            className={`px-4 ${isDark ? "bg-[#20319D] text-white/70" : "bg-white text-gray-500"}`}
          >
